 ...
 *  My Zen Thermostat
 *
 *  Author: Zen Within, modified by Bruce Ravenel
 *  Date: 2015-02-21, modified 2015-03-06
 */
metadata {
  definition (name: "ZenTest", namespace: "zentestns", author: "Zentesta") {
    capability "Actuator"
  ...
  tiles {
        ...
        standardTile("mode", "device.thermostatMode", decoration: "flat") {
            ...
            state "cool", action:"setThermostatMode", backgroundColor:"#90d0e8", icon:"st.thermostat.heat", nextState:"auto"
            state "auto", action:"setThermostatMode", backgroundColor:"#e8e3d8", icon:"st.thermostat.auto", nextState:"off"
        ...
        standardTile("thermostatOperatingState", "device.thermostatOperatingState", inactiveLabel: false) {
            state "heating", backgroundColor:"#ff6e7e", icon:"st.thermostat.heat"
            state "cooling", backgroundColor:"#90d0e8", icon:"st.thermostat.heat"
      ...
      main "frontTile"
      details(["temperature", "fanMode", "mode", "thermostatSetpoint", "setpointUp", "setpointDown", "thermostatOperatingState", "refresh", "configure"])
  }
}
...
def setThermostatMode(String value) {
	log.debug "setThermostatMode - switching to $value"
    "$value"()
}
